    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Balo Học Sinh - Sinh Viên</span>
            </nav>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <?php
            $id_category = isset($_POST['id_category']) ? intval($_POST['id_category']) : 5;
            ...
            $where_clause = " WHERE id_category = 5";
        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                ...
                <?php
                $i = 0;
                foreach ($filtered_products as $sp) {
                    extract($sp);
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item active"><a class="page-link" href="index.php?act=shop">1</a></li>
                            ...
                            <li class="page-item"><a class="page-link" href="index.php?act=shop2">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>

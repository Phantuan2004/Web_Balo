    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Balo Laptop</span>
            </nav>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <?php
            $id_category = isset($_POST['id_category']) ? intval($_POST['id_category']) : 2;
            ...
            $where_clause = " WHERE id_category = 2";
        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                ...
                <?php
                $i = 0;
                $sql = "Select * from products where id_category= 2 limit 9";
                $spnew = pdo_query($sql);
                foreach ($spnew as $sp) {
                    extract($sp);
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link" href="index.php?act=shop3">Previous</span></a></li>
                            ...
                            <li class="page-item active"><a class="page-link" href="index.php?act=shop4">4</a></li>
                            ...
                            <li class="page-item"><a class="page-link" href="index.php?act=shop5">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>

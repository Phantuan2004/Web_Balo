    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Sản phẩm giảm giá</span>
            </nav>
        </div>
    </div>
</div>
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="bg-light p-4 mb-30">
                <form id="discount-price-filter-form" method="post" action="">
                    <input type="hidden" name="filter_type" value="discount">
            ...
            <div class="row pb-3">
                ...
                <div class="container-fluid pt-5 pb-3">
                    <div class="row px-xl-5">
                        ...
                        $products = get_discounted_products($price_filters);
                        ...
                        if (!empty($products)) {
                            ...
                            foreach ($products as $product) {
                                    ...
                                    <div class="product-item bg-light mb-4">
                                        ...
                                        <div style="margin: 0 0 0 0.1rem; font-size: 14px; word-break: break-all; overflow-wrap: break-word; hyphens: auto" class="text-center py-4">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-2">
                                                <h4><p class="text-muted ml-2">$' . $product_new_price . '</p></h4>
                                                <h4><p style="text-decoration: line-through; font-size: 15px" class="text-muted ml-2">$' . $product_old_price . '</p></h4>
                                            </div>
                                ...
                                $i += 1; // Tăng biến $i sau mỗi lần lặp
                            }
                        } else {
                            echo "Không có sản phẩm nào có giảm giá trong cơ sở dữ liệu.";
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link" href="index.php?act=shop5">Previous</span></a></li>
                            ...
                            <li class="page-item active"><a class="page-link" href="index.php?act=shop6">6</a></li>
